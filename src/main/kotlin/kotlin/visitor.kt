...
abstract class Visitor {
    ...
    open fun visitTypeWithModifiers(type: TypeWithModifiers) = visitTypeRef(type)
    ...
    open fun visitBinaryOperator(token: BinaryOperator) = visitBinaryOperatorOrInfixCall(token)
    open fun visitUnaryExpression(op: UnaryExpression) = visitExpression(op)
    open fun visitUnaryOperator(oper: UnaryOperator) = visitElement(oper)
    open fun visitTypeExpression(op: TypeExpression) = visitExpression(op)
    ...
    open fun visitAnonymousObjectExpression(obj: AnonymoutObjectExpression) = visitExpression(obj)
